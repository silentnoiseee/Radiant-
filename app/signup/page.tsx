...
const roles: { id: Role; label: string; icon: typeof DoorOpen; blurb: string }[] = [
  ...
  { id: "caregiver", label: "Caregiver", icon: Heart, blurb: "Log care, give meds, report incidents, clock in." },
  { id: "manager", label: "Manager", icon: LayoutDashboard, blurb: "Full oversight of homes, staff, and compliance." },
];
    ...
    <main className="grain flex min-h-screen items-center justify-center bg-cream container-px py-12">
      ...
      >
        ...
        <div className="rounded-3xl bg-white p-8 shadow-lift border border-navy/5 sm:p-10">
          ...
          <p className="mt-1.5 text-sm text-navy/55">Pick your role — we&apos;ll tailor the app to what you do.</p>
          ...
          <form onSubmit={submit} className="mt-7 space-y-5">
            ...
            <div>
              <label className="text-xs font-bold uppercase tracking-wide text-navy/50">I am a…</label>
